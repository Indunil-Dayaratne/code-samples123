...
# Function Variables
$functionName =  $applicationPrefix.ToLower() + "-func-" + $environmentNameprefix.ToLower() + "-01";
...
# Key Vault Variables
$kvName = $applicationShortNamePrefix.ToLower() + "-kv-" + $environmentNameprefix.ToLower() + "-01";
